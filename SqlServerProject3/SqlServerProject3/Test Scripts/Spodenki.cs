...
public struct Spodenki: INullable, IBinarySerialize
{
    ...
    private bool _null;
    public Spodenki(string marka, string model, string kolor, double cena)
    {
        _marka = marka;
        _model = model;
        _kolor = kolor;
    ...
    public static Spodenki Null
    {
        get
        {
            Spodenki h = new Spodenki();
            h._null = true;
            return h;
        }
    }
    
    public static Spodenki Parse(SqlString s)
    {
        if (s.IsNull)
            return Null;
